...
def processFile(filePath):
    ...
    final_video.write_videofile(output_video_file, codec="libx264", audio_codec="aac", logger=ffmpeg_logger, temp_audiofile="temp-audio.m4a", remove_temp=True, codec_args=ffmpeg_params)
